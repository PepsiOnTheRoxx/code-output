...
class VTProceseigenaarRelatieService:
    def __init__(self):
        # In-memory storage: {taak_id: set(gebruiker_ids)}
        self._taak_proceseigenaren = {}
        # Reverse mapping: {gebruiker_id: set(taak_ids)}
        self._gebruiker_taken = {}

        # Simuleer bestaande gebruikers en taken voor testdoeleinden
