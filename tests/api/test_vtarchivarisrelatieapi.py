...
@pytest.fixture
def client():
    with patch("src.api.vtarchivarisrelatieapi.FlaskClient") as mock_client:
        yield mock_client
...
def test_get_vtarchivarisrelatie_not_found():
    with patch("src.api.vtarchivarisrelatieapi.get_vtarchivarisrelatie") as mock_get:
        mock_get.side_effect = vtarchivarisrelatieapi_exceptions.RelatieNietGevonden()
        with pytest.raises(vtarchivarisrelatieapi_exceptions.RelatieNietGevonden):
...
def test_create_vtarchivarisrelatie_invalid_input():
    data = {"naam": ""}
    with patch("src.api.vtarchivarisrelatieapi.create_vtarchivarisrelatie") as mock_create:
        mock_create.side_effect = vtarchivarisrelatieapi_exceptions.OngeldigeInput()
        with pytest.raises(vtarchivarisrelatieapi_exceptions.OngeldigeInput):
...
def test_update_vtarchivarisrelatie_not_found():
    data = {"naam": "Onbekend"}
    with patch("src.api.vtarchivarisrelatieapi.update_vtarchivarisrelatie") as mock_update:
        mock_update.side_effect = vtarchivarisrelatieapi_exceptions.RelatieNietGevonden()
        with pytest.raises(vtarchivarisrelatieapi_exceptions.RelatieNietGevonden):
...
def test_delete_vtarchivarisrelatie_not_found():
    with patch("src.api.vtarchivarisrelatieapi.delete_vtarchivarisrelatie") as mock_delete:
        mock_delete.side_effect = vtarchivarisrelatieapi_exceptions.RelatieNietGevonden()
        with pytest.raises(vtarchivarisrelatieapi_exceptions.RelatieNietGevonden):
